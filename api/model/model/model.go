...
type Course struct {
	...
	// 排课规则
	ScheduleRules []*CourseScheduleRule `thrift:"scheduleRules,3,required,list<CourseScheduleRule>" form:"scheduleRules,required" json:"scheduleRules,required" query:"scheduleRules,required"`
	// 调课规则
	AdjustRules []*CourseAdjustRule `thrift:"adjustRules,4,required,list<CourseAdjustRule>" form:"adjustRules,required" json:"adjustRules,required" query:"adjustRules,required"`
	// 备注
...
type UpYunFileDir struct {
	...
	// 当前所在目录文件
	Files []string `thrift:"files,2,required,list<string>" form:"files,required" json:"files,required" query:"files,required"`
	// 当前所在目录下的文件夹
	Folders []string `thrift:"folders,3,required,list<string>" form:"folders,required" json:"folders,required" query:"folders,required"`
}
...
type GPABean struct {
	...
	// 数据
	Data []*GPAData `thrift:"data,2,required,list<GPAData>" form:"data,required" json:"data,required" query:"data,required"`
}
...
type TermList struct {
	...
	Terms       []*Term `thrift:"terms,2,optional,list<Term>" form:"terms" json:"terms,omitempty" query:"terms"`
}
...
type TermInfo struct {
	...
	Events     []*TermEvent `thrift:"events,4,optional,list<TermEvent>" form:"events" json:"events,omitempty" query:"events"`
}
...
type CustomCourse struct {
	...
	// 上课地点
	Location *string `thrift:"location,4,optional" form:"location" json:"location,omitempty" query:"location"`
	// 课程颜色
	Color *string `thrift:"color,5,optional" form:"color" json:"color,omitempty" query:"color"`
	// 备注
	Note *string `thrift:"note,6,optional" form:"note" json:"note,omitempty" query:"note"`
	// 排课规则
	ScheduleRules []*CourseScheduleRule `thrift:"scheduleRules,7,required,list<CourseScheduleRule>" form:"scheduleRules,required" json:"scheduleRules,required" query:"scheduleRules,required"`
	// 学期
	Semester string `thrift:"semester,8,required" form:"semester,required" json:"semester,required" query:"semester,required"`
	// 最后更新时间
	LastUpdateTime string `thrift:"lastUpdateTime,9,required" form:"lastUpdateTime,required" json:"lastUpdateTime,required" query:"lastUpdateTime,required"`
	// 存储key
	StorageKey string `thrift:"storageKey,10,required" form:"storageKey,required" json:"storageKey,required" query:"storageKey,required"`
}
...
var CustomCourse_Location_DEFAULT string

func (p *CustomCourse) GetLocation() (v string) {
	if !p.IsSetLocation() {
		return CustomCourse_Location_DEFAULT
	}
	return *p.Location
}
...
var CustomCourse_Note_DEFAULT string

func (p *CustomCourse) GetNote() (v string) {
	if !p.IsSetNote() {
		return CustomCourse_Note_DEFAULT
	}
	return *p.Note
}

func (p *CustomCourse) GetScheduleRules() (v []*CourseScheduleRule) {
	return p.ScheduleRules
}

func (p *CustomCourse) GetSemester() (v string) {
	return p.Semester
}

func (p *CustomCourse) GetLastUpdateTime() (v string) {
	return p.LastUpdateTime
}

func (p *CustomCourse) GetStorageKey() (v string) {
	return p.StorageKey
}
...
func (p *CustomCourse) IsSetLocation() bool {
...
func (p *CustomCourse) IsSetNote() bool {
	return p.Note != nil
}
...
type SyncCustomCourseRequestData struct {
	ID             string                `thrift:"id,1,required" form:"id,required" json:"id,required" query:"id,required"`
	Name           string                `thrift:"name,2,required" form:"name,required" json:"name,required" query:"name,required"`
	Teacher        *string               `thrift:"teacher,3,optional" form:"teacher" json:"teacher,omitempty" query:"teacher"`
	Location       *string               `thrift:"location,4,optional" form:"location" json:"location,omitempty" query:"location"`
	...
	Note           *string               `thrift:"note,6,optional" form:"note" json:"note,omitempty" query:"note"`
	ScheduleRules  []*CourseScheduleRule `thrift:"scheduleRules,7,required,list<CourseScheduleRule>" form:"scheduleRules,required" json:"scheduleRules,required" query:"scheduleRules,required"`
	LastUpdateTime string                `thrift:"lastUpdateTime,8,required" form:"lastUpdateTime,required" json:"lastUpdateTime,required" query:"lastUpdateTime,required"`
}

func NewSyncCustomCourseRequestData() *SyncCustomCourseRequestData {
	return &SyncCustomCourseRequestData{}
}

func (p *SyncCustomCourseRequestData) InitDefault() {
}

func (p *SyncCustomCourseRequestData) GetID() (v string) {
	return p.ID
}

func (p *SyncCustomCourseRequestData) GetName() (v string) {
	return p.Name
}

var SyncCustomCourseRequestData_Teacher_DEFAULT string

func (p *SyncCustomCourseRequestData) GetTeacher() (v string) {
	if !p.IsSetTeacher() {
		return SyncCustomCourseRequestData_Teacher_DEFAULT
	}
	return *p.Teacher
}

var SyncCustomCourseRequestData_Location_DEFAULT string

func (p *SyncCustomCourseRequestData) GetLocation() (v string) {
	if !p.IsSetLocation() {
		return SyncCustomCourseRequestData_Location_DEFAULT
	}
	return *p.Location
}

var SyncCustomCourseRequestData_Color_DEFAULT string

func (p *SyncCustomCourseRequestData) GetColor() (v string) {
	if !p.IsSetColor() {
		return SyncCustomCourseRequestData_Color_DEFAULT
	}
	return *p.Color
}

var SyncCustomCourseRequestData_Note_DEFAULT string

func (p *SyncCustomCourseRequestData) GetNote() (v string) {
	if !p.IsSetNote() {
		return SyncCustomCourseRequestData_Note_DEFAULT
	}
	return *p.Note
}

func (p *SyncCustomCourseRequestData) GetScheduleRules() (v []*CourseScheduleRule) {
	return p.ScheduleRules
}

func (p *SyncCustomCourseRequestData) GetLastUpdateTime() (v string) {
	return p.LastUpdateTime
}

func (p *SyncCustomCourseRequestData) IsSetTeacher() bool {
	return p.Teacher != nil
}

func (p *SyncCustomCourseRequestData) IsSetLocation() bool {
	return p.Location != nil
}

func (p *SyncCustomCourseRequestData) IsSetColor() bool {
	return p.Color != nil
}

func (p *SyncCustomCourseRequestData) IsSetNote() bool {
	return p.Note != nil
}

func (p *SyncCustomCourseRequestData) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SyncCustomCourseRequestData(%+v)", *p)
}

type SyncCustomCourseResponseData struct {
	ID             string                `thrift:"id,1,required" form:"id,required" json:"id,required" query:"id,required"`
	Name           string                `thrift:"name,2,required" form:"name,required" json:"name,required" query:"name,required"`
	Teacher        *string               `thrift:"teacher,3,optional" form:"teacher" json:"teacher,omitempty" query:"teacher"`
	Location       *string               `thrift:"location,4,optional" form:"location" json:"location,omitempty" query:"location"`
...
func NewSyncCustomCourseResponseData() *SyncCustomCourseResponseData {
	return &SyncCustomCourseResponseData{}
}

func (p *SyncCustomCourseResponseData) InitDefault() {
}

func (p *SyncCustomCourseResponseData) GetID() (v string) {
	return p.ID
}

func (p *SyncCustomCourseResponseData) GetName() (v string) {
	return p.Name
}

var SyncCustomCourseResponseData_Teacher_DEFAULT string

func (p *SyncCustomCourseResponseData) GetTeacher() (v string) {
	if !p.IsSetTeacher() {
		return SyncCustomCourseResponseData_Teacher_DEFAULT
	}
	return *p.Teacher
}

var SyncCustomCourseResponseData_Location_DEFAULT string

func (p *SyncCustomCourseResponseData) GetLocation() (v string) {
	if !p.IsSetLocation() {
		return SyncCustomCourseResponseData_Location_DEFAULT
	}
	return *p.Location
}

var SyncCustomCourseResponseData_Color_DEFAULT string

func (p *SyncCustomCourseResponseData) GetColor() (v string) {
	if !p.IsSetColor() {
		return SyncCustomCourseResponseData_Color_DEFAULT
	}
	return *p.Color
}

var SyncCustomCourseResponseData_Note_DEFAULT string

func (p *SyncCustomCourseResponseData) GetNote() (v string) {
	if !p.IsSetNote() {
		return SyncCustomCourseResponseData_Note_DEFAULT
	}
	return *p.Note
}

func (p *SyncCustomCourseResponseData) GetScheduleRules() (v []*CourseScheduleRule) {
	return p.ScheduleRules
}

func (p *SyncCustomCourseResponseData) GetSemester() (v string) {
	return p.Semester
}

func (p *SyncCustomCourseResponseData) GetLastUpdateTime() (v string) {
	return p.LastUpdateTime
}

func (p *SyncCustomCourseResponseData) GetStorageKey() (v string) {
	return p.StorageKey
}

func (p *SyncCustomCourseResponseData) IsSetTeacher() bool {
	return p.Teacher != nil
}

func (p *SyncCustomCourseResponseData) IsSetLocation() bool {
	return p.Location != nil
}

func (p *SyncCustomCourseResponseData) IsSetColor() bool {
	return p.Color != nil
}

func (p *SyncCustomCourseResponseData) IsSetNote() bool {
	return p.Note != nil
}

func (p *SyncCustomCourseResponseData) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SyncCustomCourseResponseData(%+v)", *p)
}
