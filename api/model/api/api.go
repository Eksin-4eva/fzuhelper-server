...
type EmptyClassroomResponse struct {
	Classrooms []*model.Classroom `thrift:"classrooms,1,optional,list<model.Classroom>" form:"classrooms" json:"classrooms,omitempty" query:"classrooms"`
}
...
type ExamRoomInfoResponse struct {
	ExamRoomInfos []*model.ExamRoomInfo `thrift:"examRoomInfos,1,optional,list<model.ExamRoomInfo>" form:"examRoomInfos" json:"examRoomInfos,omitempty" query:"examRoomInfos"`
}
...
type GetFriendListResponse struct {
	Base *model.BaseResp         `thrift:"base,1,required" form:"base,required" json:"base,required" query:"base,required"`
	Data []*model.UserFriendInfo `thrift:"data,2,required,list<model.UserFriendInfo>" form:"data,required" json:"data,required" query:"data,required"`
}
...
type ReorderFriendListRequest struct {
	FriendIds []string `thrift:"friend_ids,1,required,list<string>" form:"friend_ids,required" json:"friend_ids,required" query:"friend_ids,required"`
}
...
type CourseTermListResponse struct {
	Base *model.BaseResp `thrift:"base,1,required" form:"base,required" json:"base,required" query:"base,required"`
	Data []string        `thrift:"data,2,required,list<string>" form:"data,required" json:"data,required" query:"data,required"`
}
...
type GetAutoAdjustCourseListResponse struct {
	Base *model.BaseResp       `thrift:"base,1,required" form:"base,required" json:"base,required" query:"base,required"`
	Data []*model.AdjustCourse `thrift:"data,2,required,list<model.AdjustCourse>" form:"data,required" json:"data,required" query:"data,required"`
}
...
type UploadCustomCourseRequest struct {
	Semester string                               `thrift:"semester,1,required" form:"semester,required" json:"semester,required" query:"semester,required"`
	Courses  []*model.SyncCustomCourseRequestData `thrift:"courses,2,required,list<model.SyncCustomCourseRequestData>" form:"courses,required" json:"courses,required" query:"courses,required"`
}

func NewUploadCustomCourseRequest() *UploadCustomCourseRequest {
	return &UploadCustomCourseRequest{}
}

func (p *UploadCustomCourseRequest) InitDefault() {
}

func (p *UploadCustomCourseRequest) GetSemester() (v string) {
	return p.Semester
}

func (p *UploadCustomCourseRequest) GetCourses() (v []*model.SyncCustomCourseRequestData) {
	return p.Courses
}

func (p *UploadCustomCourseRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UploadCustomCourseRequest(%+v)", *p)
}

type UploadCustomCourseResponse struct {
	Base          *model.BaseResp `thrift:"base,1,required" form:"base,required" json:"base,required" query:"base,required"`
	ServerVersion int64           `thrift:"server_version,2,required" form:"server_version,required" json:"server_version,required" query:"server_version,required"`
}

func NewUploadCustomCourseResponse() *UploadCustomCourseResponse {
	return &UploadCustomCourseResponse{}
}

func (p *UploadCustomCourseResponse) InitDefault() {
}

var UploadCustomCourseResponse_Base_DEFAULT *model.BaseResp

func (p *UploadCustomCourseResponse) GetBase() (v *model.BaseResp) {
	if !p.IsSetBase() {
		return UploadCustomCourseResponse_Base_DEFAULT
	}
	return p.Base
}

func (p *UploadCustomCourseResponse) GetServerVersion() (v int64) {
	return p.ServerVersion
}

func (p *UploadCustomCourseResponse) IsSetBase() bool {
	return p.Base != nil
}

func (p *UploadCustomCourseResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UploadCustomCourseResponse(%+v)", *p)
}

type GetCustomCourseListRequest struct {
	Semester string `thrift:"semester,1,required" form:"semester,required" json:"semester,required" query:"semester,required"`
}

func NewGetCustomCourseListRequest() *GetCustomCourseListRequest {
	return &GetCustomCourseListRequest{}
}

func (p *GetCustomCourseListRequest) InitDefault() {
}

func (p *GetCustomCourseListRequest) GetSemester() (v string) {
	return p.Semester
}

func (p *GetCustomCourseListRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("GetCustomCourseListRequest(%+v)", *p)
}

type GetCustomCourseListResponse struct {
	Base          *model.BaseResp       `thrift:"base,1,required" form:"base,required" json:"base,required" query:"base,required"`
	ServerVersion int64                 `thrift:"server_version,2,required" form:"server_version,required" json:"server_version,required" query:"server_version,required"`
	Data          []*model.CustomCourse `thrift:"data,3,required,list<model.CustomCourse>" form:"data,required" json:"data,required" query:"data,required"`
}

func NewGetCustomCourseListResponse() *GetCustomCourseListResponse {
	return &GetCustomCourseListResponse{}
}

func (p *GetCustomCourseListResponse) InitDefault() {
}

var GetCustomCourseListResponse_Base_DEFAULT *model.BaseResp

func (p *GetCustomCourseListResponse) GetBase() (v *model.BaseResp) {
	if !p.IsSetBase() {
		return GetCustomCourseListResponse_Base_DEFAULT
	}
	return p.Base
}

func (p *GetCustomCourseListResponse) GetServerVersion() (v int64) {
	return p.ServerVersion
}

func (p *GetCustomCourseListResponse) GetData() (v []*model.CustomCourse) {
	return p.Data
}

func (p *GetCustomCourseListResponse) IsSetBase() bool {
	return p.Base != nil
}

func (p *GetCustomCourseListResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("GetCustomCourseListResponse(%+v)", *p)
}

type SyncCustomCourseRequest struct {
	Semester         string                               `thrift:"semester,1,required" form:"semester,required" json:"semester,required" query:"semester,required"`
	ClientVersion    int64                                `thrift:"client_version,2,required" form:"client_version,required" json:"client_version,required" query:"client_version,required"`
	AddedCourses     []*model.SyncCustomCourseRequestData `thrift:"added_courses,3,optional,list<model.SyncCustomCourseRequestData>" form:"added_courses" json:"added_courses,omitempty" query:"added_courses"`
	UpdatedCourses   []*model.SyncCustomCourseRequestData `thrift:"updated_courses,4,optional,list<model.SyncCustomCourseRequestData>" form:"updated_courses" json:"updated_courses,omitempty" query:"updated_courses"`
	DeletedCourseIds []string                             `thrift:"deleted_course_ids,5,optional,list<string>" form:"deleted_course_ids" json:"deleted_course_ids,omitempty" query:"deleted_course_ids"`
}

func NewSyncCustomCourseRequest() *SyncCustomCourseRequest {
	return &SyncCustomCourseRequest{}
}

func (p *SyncCustomCourseRequest) InitDefault() {
}

func (p *SyncCustomCourseRequest) GetSemester() (v string) {
	return p.Semester
}

func (p *SyncCustomCourseRequest) GetClientVersion() (v int64) {
	return p.ClientVersion
}

var SyncCustomCourseRequest_AddedCourses_DEFAULT []*model.SyncCustomCourseRequestData

func (p *SyncCustomCourseRequest) GetAddedCourses() (v []*model.SyncCustomCourseRequestData) {
	if !p.IsSetAddedCourses() {
		return SyncCustomCourseRequest_AddedCourses_DEFAULT
	}
	return p.AddedCourses
}

var SyncCustomCourseRequest_UpdatedCourses_DEFAULT []*model.SyncCustomCourseRequestData

func (p *SyncCustomCourseRequest) GetUpdatedCourses() (v []*model.SyncCustomCourseRequestData) {
	if !p.IsSetUpdatedCourses() {
		return SyncCustomCourseRequest_UpdatedCourses_DEFAULT
	}
	return p.UpdatedCourses
}

var SyncCustomCourseRequest_DeletedCourseIds_DEFAULT []string

func (p *SyncCustomCourseRequest) GetDeletedCourseIds() (v []string) {
	if !p.IsSetDeletedCourseIds() {
		return SyncCustomCourseRequest_DeletedCourseIds_DEFAULT
	}
	return p.DeletedCourseIds
}

func (p *SyncCustomCourseRequest) IsSetAddedCourses() bool {
	return p.AddedCourses != nil
}

func (p *SyncCustomCourseRequest) IsSetUpdatedCourses() bool {
	return p.UpdatedCourses != nil
}

func (p *SyncCustomCourseRequest) IsSetDeletedCourseIds() bool {
	return p.DeletedCourseIds != nil
}

func (p *SyncCustomCourseRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SyncCustomCourseRequest(%+v)", *p)
}

type SyncCustomCourseResponse struct {
	Base             *model.BaseResp                       `thrift:"base,1,required" form:"base,required" json:"base,required" query:"base,required"`
	ServerVersion    int64                                 `thrift:"server_version,2,required" form:"server_version,required" json:"server_version,required" query:"server_version,required"`
	NewCourses       []*model.SyncCustomCourseResponseData `thrift:"new_courses,3,optional,list<model.SyncCustomCourseResponseData>" form:"new_courses" json:"new_courses,omitempty" query:"new_courses"`
	UpdatedCourses   []*model.SyncCustomCourseResponseData `thrift:"updated_courses,4,optional,list<model.SyncCustomCourseResponseData>" form:"updated_courses" json:"updated_courses,omitempty" query:"updated_courses"`
	DeletedCourseIds []string                              `thrift:"deleted_course_ids,5,optional,list<string>" form:"deleted_course_ids" json:"deleted_course_ids,omitempty" query:"deleted_course_ids"`
}

func NewSyncCustomCourseResponse() *SyncCustomCourseResponse {
	return &SyncCustomCourseResponse{}
}

func (p *SyncCustomCourseResponse) InitDefault() {
}

var SyncCustomCourseResponse_Base_DEFAULT *model.BaseResp

func (p *SyncCustomCourseResponse) GetBase() (v *model.BaseResp) {
	if !p.IsSetBase() {
		return SyncCustomCourseResponse_Base_DEFAULT
	}
	return p.Base
}

func (p *SyncCustomCourseResponse) GetServerVersion() (v int64) {
	return p.ServerVersion
}

var SyncCustomCourseResponse_NewCourses_DEFAULT []*model.SyncCustomCourseResponseData

func (p *SyncCustomCourseResponse) GetNewCourses() (v []*model.SyncCustomCourseResponseData) {
	if !p.IsSetNewCourses() {
		return SyncCustomCourseResponse_NewCourses_DEFAULT
	}
	return p.NewCourses
}

var SyncCustomCourseResponse_UpdatedCourses_DEFAULT []*model.SyncCustomCourseResponseData

func (p *SyncCustomCourseResponse) GetUpdatedCourses() (v []*model.SyncCustomCourseResponseData) {
	if !p.IsSetUpdatedCourses() {
		return SyncCustomCourseResponse_UpdatedCourses_DEFAULT
	}
	return p.UpdatedCourses
}

var SyncCustomCourseResponse_DeletedCourseIds_DEFAULT []string

func (p *SyncCustomCourseResponse) GetDeletedCourseIds() (v []string) {
	if !p.IsSetDeletedCourseIds() {
		return SyncCustomCourseResponse_DeletedCourseIds_DEFAULT
	}
	return p.DeletedCourseIds
}

func (p *SyncCustomCourseResponse) IsSetBase() bool {
	return p.Base != nil
}

func (p *SyncCustomCourseResponse) IsSetNewCourses() bool {
	return p.NewCourses != nil
}

func (p *SyncCustomCourseResponse) IsSetUpdatedCourses() bool {
	return p.UpdatedCourses != nil
}

func (p *SyncCustomCourseResponse) IsSetDeletedCourseIds() bool {
	return p.DeletedCourseIds != nil
}

func (p *SyncCustomCourseResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SyncCustomCourseResponse(%+v)", *p)
}

type DeleteCustomCourseRequest struct {
	Semester  string   `thrift:"semester,1,required" form:"semester,required" json:"semester,required" query:"semester,required"`
	CourseIds []string `thrift:"course_ids,2,required,list<string>" form:"course_ids,required" json:"course_ids,required" query:"course_ids,required"`
}
...
func (p *DeleteCustomCourseRequest) GetSemester() (v string) {
	return p.Semester
}

func (p *DeleteCustomCourseRequest) GetCourseIds() (v []string) {
	return p.CourseIds
}
...
type MobileGetImageResponse struct {
	...
	PictureList []*model.Picture `thrift:"picture_list,3,optional,list<model.Picture>" form:"picture_list" json:"picture_list,omitempty" query:"picture_list"`
}
...
type GetScoresResponse struct {
	Scores []*model.Score `thrift:"scores,1,required,list<model.Score>" form:"scores,required" json:"scores,required" query:"scores,required"`
}
...
type GetCreditResponse struct {
	Major []*model.Credit `thrift:"major,1,required,list<model.Credit>" form:"major,required" json:"major,required" query:"major,required"`
}
...
type GetUnifiedExamResponse struct {
	UnifiedExam []*model.UnifiedExam `thrift:"unifiedExam,1,required,list<model.UnifiedExam>" form:"unifiedExam,required" json:"unifiedExam,required" query:"unifiedExam,required"`
}
...
type GetCreditV2Response struct {
	Base   *model.BaseResp      `thrift:"base,1,required" form:"base,required" json:"base,required" query:"base,required"`
	Credit model.CreditResponse `thrift:"credit,2,optional,list<model.CreditCategory>" form:"credit" json:"credit,omitempty" query:"credit"`
}
...
type GetNoticeResponse struct {
	Notices []*model.NoticeInfo `thrift:"notices,1,required,list<model.NoticeInfo>" form:"notices,required" json:"notices,required" query:"notices,required"`
...
type GetContributorInfoResponse struct {
	FzuhelperApp    []*model.Contributor `thrift:"fzuhelper_app,1,required,list<model.Contributor>" form:"fzuhelper_app,required" json:"fzuhelper_app,required" query:"fzuhelper_app,required"`
	FzuhelperServer []*model.Contributor `thrift:"fzuhelper_server,2,required,list<model.Contributor>" form:"fzuhelper_server,required" json:"fzuhelper_server,required" query:"fzuhelper_server,required"`
	Jwch            []*model.Contributor `thrift:"jwch,3,required,list<model.Contributor>" form:"jwch,required" json:"jwch,required" query:"jwch,required"`
	Yjsy            []*model.Contributor `thrift:"yjsy,4,required,list<model.Contributor>" form:"yjsy,required" json:"yjsy,required" query:"yjsy,required"`
}
...
type GetToolboxConfigResponse struct {
	Config []*model.ToolboxConfig `thrift:"config,1,required,list<model.ToolboxConfig>" form:"config,required" json:"config,required" query:"config,required"`
}
...
type CourseService interface {
	...
	// 上传自定义课程列表
	UploadCustomCourse(ctx context.Context, req *UploadCustomCourseRequest) (r *UploadCustomCourseResponse, err error)
	// 获取自定义课程列表
	GetCustomCourseList(ctx context.Context, req *GetCustomCourseListRequest) (r *GetCustomCourseListResponse, err error)
	// 同步自定义课程（增量同步）
	SyncCustomCourse(ctx context.Context, req *SyncCustomCourseRequest) (r *SyncCustomCourseResponse, err error)
	// 删除自定义课程
