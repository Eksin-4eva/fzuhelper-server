...
type CourseListV2Request struct {
	Term      string `thrift:"term,1,required" form:"term,required" json:"term,required" query:"term,required"`
	IsRefresh *bool  `thrift:"is_refresh,2,optional" form:"is_refresh" json:"is_refresh,omitempty" query:"is_refresh"`
}

func NewCourseListV2Request() *CourseListV2Request {
	return &CourseListV2Request{}
}

func (p *CourseListV2Request) InitDefault() {
}

func (p *CourseListV2Request) GetTerm() (v string) {
	return p.Term
}

var CourseListV2Request_IsRefresh_DEFAULT bool

func (p *CourseListV2Request) GetIsRefresh() (v bool) {
	if !p.IsSetIsRefresh() {
		return CourseListV2Request_IsRefresh_DEFAULT
	}
	return *p.IsRefresh
}

func (p *CourseListV2Request) IsSetIsRefresh() bool {
	return p.IsRefresh != nil
}

func (p *CourseListV2Request) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CourseListV2Request(%+v)", *p)
}

type CourseListV2Response struct {
	Base          *model.BaseResp     `thrift:"base,1,required" form:"base,required" json:"base,required" query:"base,required"`
	Data          []*model.Course     `thrift:"data,2,required,list<model.Course>" form:"data,required" json:"data,required" query:"data,required"`
	CustomCourses []*CustomCourseItem `thrift:"custom_courses,3,required,list<CustomCourseItem>" form:"custom_courses,required" json:"custom_courses,required" query:"custom_courses,required"`
}

func NewCourseListV2Response() *CourseListV2Response {
	return &CourseListV2Response{}
}

func (p *CourseListV2Response) InitDefault() {
}

var CourseListV2Response_Base_DEFAULT *model.BaseResp

func (p *CourseListV2Response) GetBase() (v *model.BaseResp) {
	if !p.IsSetBase() {
		return CourseListV2Response_Base_DEFAULT
	}
	return p.Base
}

func (p *CourseListV2Response) GetData() (v []*model.Course) {
	return p.Data
}

func (p *CourseListV2Response) GetCustomCourses() (v []*CustomCourseItem) {
	return p.CustomCourses
}
...
type CreateToolboxConfigRequest struct {
	...
	StudentID *string `thrift:"student_id,9,optional" form:"student_id" json:"student_id,omitempty" query:"student_id"`
	Platform  *string `thrift:"platform,10,optional" form:"platform" json:"platform,omitempty" query:"platform"`
	Version   *int64  `thrift:"version,11,optional" form:"version" json:"version,omitempty" query:"version"`
}
...
type CreateToolboxConfigResponse struct {
	Config *model.ToolboxConfigDetail `thrift:"config,1,required" form:"config,required" json:"config,required" query:"config,required"`
}
...
type ListToolboxConfigsRequest struct {
	...
	StudentID *string `thrift:"student_id,5,optional" form:"student_id" json:"student_id,omitempty" query:"student_id"`
	Platform  *string `thrift:"platform,6,optional" form:"platform" json:"platform,omitempty" query:"platform"`
	Version   *int64  `thrift:"version,7,optional" form:"version" json:"version,omitempty" query:"version"`
}
...
type ListToolboxConfigsResponse struct {
	Config []*model.ToolboxConfigDetail `thrift:"config,1,required,list<model.ToolboxConfigDetail>" form:"config,required" json:"config,required" query:"config,required"`
	Total  int64                        `thrift:"total,2,required" form:"total,required" json:"total,required" query:"total,required"`
}
...
type UpdateToolboxConfigRequest struct {
	...
	Extra     *string `thrift:"extra,9,optional" form:"extra" json:"extra,omitempty" query:"extra"`
	StudentID *string `thrift:"student_id,10,optional" form:"student_id" json:"student_id,omitempty" query:"student_id"`
	Platform  *string `thrift:"platform,11,optional" form:"platform" json:"platform,omitempty" query:"platform"`
	Version   *int64  `thrift:"version,12,optional" form:"version" json:"version,omitempty" query:"version"`
}
...
type GetSignedLocationApiUrlResponse struct {
	// 签好名的完整请求 URL
	SignedURL string `thrift:"signed_url,1,required" form:"signed_url,required" json:"signed_url,required" query:"signed_url,required"`
	// 客户端发请求时需携带的 Headers
	Headers map[string]string `thrift:"headers,2,required" form:"headers,required" json:"headers,required" query:"headers,required"`
}
...
type CourseService interface {
	...
	GetCourseListV2(ctx context.Context, req *CourseListV2Request) (r *CourseListV2Response, err error)
	// 获取学期
