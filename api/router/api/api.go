		...
		}
		{
			...
			}
			{
				...
				}
				{
					...
					{
						_custom := _course0.Group("/custom", _customMw()...)
						_custom.POST("/delete", append(_deletecustomcourseMw(), api.DeleteCustomCourse)...)
						_custom.GET("/list", append(_getcustomcourselistMw(), api.GetCustomCourseList)...)
						_custom.POST("/sync", append(_synccustomcourseMw(), api.SyncCustomCourse)...)
						_custom.POST("/upload", append(_uploadcustomcourseMw(), api.UploadCustomCourse)...)
					}
				}
				{
			...
			}
			{
				...
				_user2.POST("/validate-code", append(_validatecodeMw(), api.ValidateCode)...)
				{
					...
					_friend0.POST("/reorder", append(_reorderfriendlistMw(), api.ReorderFriendList)...)
				}
			}
		}
		{
